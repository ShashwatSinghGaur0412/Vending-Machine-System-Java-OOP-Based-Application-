...
public class Wine extends Beverage{
	...
	public Wine(String size, String suger, String iceLevel, String temperature, String strength, String extra) {
		this.size = size;
		this.suger = suger;
	...
	public void prepareDrink() {
	    System.out.println("Finalizing your customized Wine...");
	    System.out.println("Mixing ingredients with precision");
	    System.out.println("Almost ready...");
	    System.out.println("Your Wine is ready. Enjoy your drink!");
	}
