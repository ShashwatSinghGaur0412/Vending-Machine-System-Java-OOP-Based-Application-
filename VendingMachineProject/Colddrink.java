...
public class Colddrink extends Beverage {
	...
	public Colddrink(String size, String suger, String iceLevel, String temperature, String strength, String extra) {
		this.size = size;
		this.suger = suger;
	...
	public void prepareDrink() {
	    System.out.println("Finalizing your customized Colddrink...");
	    System.out.println("Mixing ingredients with precision 🍸");
	    System.out.println("Almost ready...");
	    System.out.println("Your Colddrink is ready. Enjoy your drink!");
	}
