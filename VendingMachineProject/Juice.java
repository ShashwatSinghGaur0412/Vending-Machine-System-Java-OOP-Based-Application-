...
public class Juice extends Beverage {
	...
	public Juice(String size, String suger, String iceLevel, String temperature, String strength, String extra) {
		this.size = size;
		this.suger = suger;
	...
	public void prepareDrink() {
	    System.out.println("Finalizing your customized Juice...");
	    System.out.println("Mixing ingredients with precision ");
	    System.out.println("Almost ready...");
	    System.out.println("Your Juice is ready. Enjoy your drink!");
	}
